    ...
    <div className="w-full h-screen flex flex-col justify-center items-center mx-auto bg-[#DBE2EF]">
      <div className="flex flex-col gap-4 border p-10 rounded-lg shadow-lg justify-center items-center mx-auto bg-white">
        ...
        <div className="flex flex-col gap-4 w-80">
          ...
          <label className="select text-black border-black">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            ...
            <select placeholder="Budget Period" required>
              <option>Daily</option>
          ...
          <label className="input text-black border-black">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            ...
            <input type="date" placeholder="Budget Start Date" />
          </label>
          <label className="input text-black border-black">
            <svg
              xmlns="http://www.w3.org/2000/svg"
